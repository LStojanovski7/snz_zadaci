...
if __name__ == '__main__':
    ...
    divide = len(train_data) * 70 // 100

    train_set = train_data[:divide]
    test_set = train_data[divide:]

    c1 = NaiveBayes(get_words_custom)

    for doc in train_set:
        c1.train(doc[0], doc[1])
    ...
    for doc in test_set:
        ...
        class1 = c1.classify_document(doc[0])
