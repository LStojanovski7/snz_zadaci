"""
Да се направи модел за класификација за даденото податочно множество. За тренинг да се земат само првите
40 примероци од класите Roach и Pike (Првите 40 од Roach и првите 40 од Pike). Значи треба да се направи бинарен
класификатор, при што секоја класа освен _Roach_ и _Pike_ се игнорира при тренирањето на множеството. Притоа
земањето на првите 40 примероци да се направи во програмата, а не со рачно копирање! Ако во множеството има помалку
од 40 примероци од дадена класа, се земаат онолку колку што има (т.е. сите што ги има).

Да се класифицира елементот даден на влез и да се испечати предвидувањето. На влез се добива цела листа која директно
може да се прочита со една input() наредба и потоа може да класифицира без никави кастирања и рачно парсирање.
"""
...
if __name__ == "__main__":
    ...
    # lista_vtora_opcija = [x for x in data if x[-1] == 'Roach']
